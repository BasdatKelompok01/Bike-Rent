...
<html lang="en">
    <head>
          <title><?=isset($title)?$title:'Bike Rent Login' ?></title>
...
<body style="background: #e8e8ea; ">
    ...
    .login-form input[type=text], .login-form input[type=password], .login-form input[type=number], .login-form input[type=email]{
        margin-bottom:10px;
    }
