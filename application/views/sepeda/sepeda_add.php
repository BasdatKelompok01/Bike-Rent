    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Form Penambahan Sepeda</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
          ...
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('index.php/sepeda/add'), 'class="form-horizontal"');  ?> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                <input type="text" name="merk" id="merk" maxlength=10 class="form-control">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                <input type="text" name="jenis" id="jenis" maxlength=50 class="form-control">
                </div>
              </div>
