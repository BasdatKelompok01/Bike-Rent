          ...
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                <input type="text" name="tglMulai" id="tglMulai" value="15-04-2019 08:00" class="form-control datetimemask">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="tglSelesai" id="tglSelesai" value="15-04-2019 16:00" class="form-control datetimemask">   
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <a href="<?= base_url('penugasan'); ?>" class="btn btn-default">Batal</a>
                </div>
              </div>
            <?php echo form_close(); ?>
          </div>
