      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('index.php/acara/edit/'.$acara['id_acara']), 'class="form-horizontal"' )?> 
              
            <div class="form-group">
                <label for="judul" class="col-sm-3 control-label">Judul</label>

                <div class="col-sm-9">
                  <input type="text" name="judul" id="judul" maxlength=100 class="form-control" value="<?php echo $acara['judul'];?>">   
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="deskripsi" id="deskripsi" maxlength=200 class="form-control" value="<?php echo $acara['deskripsi'];?>">   
                </div>
              </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="gratis" class="form-control">
                    ...
                    <option value="1" <?= ($acara['is_free'] == 't')?'selected': '' ?> >Ya</option>
                    <option value="0" <?= ($acara['is_free'] == 'f')?'selected': '' ?> >Tidak</option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="tglMulai" id="tglMulai" class="form-control" value="<?php echo Date('Y-m-d', strtotime($acara['tgl_mulai']));?>" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                <input type="text" name="tglSelesai" id="tglSelesai" class="form-control" value="<?php echo Date('Y-m-d', strtotime($acara['tgl_akhir']));?>" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <?= form_multiselect('stasiun[]', $stasiuns, $acarastasiun, 'class="form-control"'); ?>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <a href="<?= base_url('index.php/acara'); ?>" class="btn btn-default">Batal</a>
                </div>
              </div>
            <?php echo form_close(); ?>
          </div>
